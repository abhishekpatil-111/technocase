<?php
	...
	$query="insert into now_available(id,name,poster,rate,rdate,duration,language,category,category2) values($mid,'$name','$poster',$rate,'$rdate','$duration','$lang','$cat1','$cat2')";
	$posterpath="".$poster;
